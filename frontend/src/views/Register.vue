        ...
        username: [
          'username',
          {
            rules: [
              ...
              { min: 2, message: 'Username should have a minimum length of 2 characters.\n' },
              { max: 64, message: 'Username should have a maximum length of 64 characters.\n' },
            ],
          },
        ],
        email: [
...
.register
  a-card
    a-form(:form="form" @submit="register")
      ...
      a-form-item(label="User Name" v-bind="formItemLayout")
        a-input(placeholder="User name" v-decorator="validationRules.username")
